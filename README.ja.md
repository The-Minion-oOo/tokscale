...
| <img width="48px" src="https://github.com/lmstudio-ai.png" alt="LM Studio" /> | [LM Studio](https://lmstudio.ai/) | `~/.lmstudio/server-logs/**/*.log`（`LM_STUDIO_HOME` 対応、ローカルサーバーの最終応答 usage のみ。プロンプトと応答本文は保持せず、ローカル推論のコストは $0） |
